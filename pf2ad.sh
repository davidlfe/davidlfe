...
fetch -o /usr/local/pkg -q https://github.com/davidlfe/davidlfe/blob/master/samba.inc
fetch -o /usr/local/pkg -q https://github.com/davidlfe/davidlfe/blob/master/samba.xml
...
cd /usr/local/pkg
fetch -o - -q https://github.com/davidlfe/davidlfe/blob/master/squid_winbind_auth.patch | patch -b -p0 -f
fetch -o /usr/local/pkg -q https://github.com/davidlfe/davidlfe/blob/master/squid.inc
